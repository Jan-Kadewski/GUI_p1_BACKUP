...
public class Person {
    ...
    public static void payForRent(Scanner sc) {
        if (Main.choosenPerson.listOfTenantAlert.size() == 0) {
            System.out.println("Zapłać za pomieszczenie po terminie ");
        } else {
            System.out.println("Lista zadłużonych pomieszczeń");
...
//            System.out.println("Zadłużenie za parking o ID nr: " + ps.id + " na kwotę: " + ps.price);
        }
    }
    ...
    public static void totalWarehouseRentCost() {
        for (int i = 0; i < Main.choosenPerson.listOfRentedArea.size(); i++) {
            ...
            System.out.println("Zadłużenie za pomieszczenie o ID nr " + Main.choosenPerson.listOfRentedArea.get(i).id + " na kwotę " + Main.choosenPerson.listOfRentedArea.get(i).costOfRentSpace);
        }
